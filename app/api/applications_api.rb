...
require_relative '../api/entities/application_entity'
require_relative '../api/entities/error_redirect_entity'
require_relative '../api/entities/error_not_found_entity'
require_relative '../api/entities/error_boom_entity'
require_relative '../api/entities/detailed_status_entity'
